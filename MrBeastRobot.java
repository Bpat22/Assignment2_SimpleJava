/*MrRobot robot face program
 * this program uses center, height and width to draw robot face
 */
import acm.program.*;
import java.awt.*;
...
public class MrBeastRobot extends GraphicsProgram{
	...
	//main method
	public void run() {
		mrRobot(getWidth() / 2, getHeight() / 2);
	}
	...
	private void mrRobot(double centerX, double centerY) {
